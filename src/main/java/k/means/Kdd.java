...
public class Kdd implements Serializable {
    ...
    public String getWrong_fragment() {
        return wrong_fragment;
    }

    public void setWrong_fragment(String wrong_fragment) {
    ...
    public String getNum_failed_logins() {
        return num_failed_logins;
    }

    public void setNum_failed_logins(String num_failed_logins) {
    ...
    public String getNum_compromised() {
        return num_compromised;
    }

    public void setNum_compromised(String num_compromised) {
        this.num_compromised = num_compromised;
    }

    public String getRoot_shell() {
        return root_shell;
    }

    public void setRoot_shell(String root_shell) {
        this.root_shell = root_shell;
    }

    public String getSu_attempted() {
        return su_attempted;
    }

    public void setSu_attempted(String su_attempted) {
        this.su_attempted = su_attempted;
    }

    public String getNum_root() {
        return num_root;
    }

    public void setNum_root(String num_root) {
        this.num_root = num_root;
    }

    public String getNum_file_creations() {
        return num_file_creations;
    }

    public void setNum_file_creations(String num_file_creations) {
        this.num_file_creations = num_file_creations;
    }

    public String getNum_shells() {
        return num_shells;
    }

    public void setNum_shells(String num_shells) {
        this.num_shells = num_shells;
    }

    public String getNum_access_files() {
        return num_access_files;
    }

    public void setNum_access_files(String num_access_files) {
        this.num_access_files = num_access_files;
    }

    public String getNum_outbound_cmds() {
        return num_outbound_cmds;
    }

    public void setNum_outbound_cmds(String num_outbound_cmds) {
